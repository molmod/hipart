...
class Options(object):
    def __init__(self, lebedev=110, do_clean=False, do_work=True, do_output=True, verbose=True, threshold=1e-4, max_iter=500, fix_total_charge=True, do_random=True, save_mem=False):
